...
esp_err_t stream_ui_handler(httpd_req_t *req) {
...
void startCameraServer() {
  ...
  if (httpd_start(&camera_httpd, &config) == ESP_OK) {
    ...
    httpd_register_uri_handler(camera_httpd, &redirect_root);
    httpd_register_uri_handler(camera_httpd, &stream_ui_uri);
